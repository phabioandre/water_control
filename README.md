...
## Requisitos básicos
- Acessar plataforma interna de IOT  ao Grupo para exibir informações de supervisão em tempo real de um viveiro;
- Permitir que dados históricos das medições do viveiro sejam exibidos;
